  ...
  const colors = [
    {
      name: "Aurora Mint",
      value: "#3fe0c5",
      desc: "Soft Mint – Calm, Fresh & Modern",
    },
    {
      name: "Cobalt Edge",
      value: "#4361ee",
      desc: "Electric Blue – Sharp, Confident & Precise",
    },
    {
      name: "Saffron",
      value: "#f4c430",
      desc: "Warm yellow - elegant and optimistic.",
    },
    {
      name: "Emerald",
      value: "#2ecc71",
      desc: "Pakistan Green – Professional & Natural",
    },
    {
      name: "Slate",
      value: "#708090",
      desc: "Modern Gray – Minimalist & Clean",
    },
  ];

  const [activeColor, setActiveColor] = useState(DEFAULT_COLOR);
  const [isOpen, setIsOpen] = useState(false);
  const [activeTab, setActiveTab] = useState<"colors" | "theme">("colors"); // Track active tab
    ...
    <>
      ...
      >
        ...
        <svg
          ...
          strokeLinecap="round"
          strokeLinejoin="round"
          className="lucide lucide-monitor text-muted-foreground"
          aria-hidden="true"
        >
      ...
      {isOpen && (
        <div
          ref={menuRef}
          className="absolute right-7 top-22 w-72 bg-background rounded-xl shadow-2xl border border-(--primary-color)/50 z-50 p-4 animate-slideDown"
